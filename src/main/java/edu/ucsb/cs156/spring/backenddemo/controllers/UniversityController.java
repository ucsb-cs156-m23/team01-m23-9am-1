...
public class UniversityController {
    ...
    @Operation(
        summary = "Get domains of a university by name", 
        description = "JSON return format documented here: https://github.com/Hipo/university-domains-list/blob/master/README.md"
    )

    @GetMapping("/get")
    public ResponseEntity<String> getUniversity(
        @Parameter(name="name", description="name of the university", example="University of California, Santa Barbara") @RequestParam String name
    ) throws Exception {
